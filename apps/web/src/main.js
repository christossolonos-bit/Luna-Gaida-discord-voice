...
function BrowserChat({ guildId, voiceEnabled }) {
    ...
    return (_jsxs("section", { className: "chat", children: [_jsxs("div", { className: "chat-status", children: [_jsx("span", { className: status === 'connected' ? 'online' : '' }), status] }), _jsxs("div", { className: "messages", children: [messages.length === 0 && _jsx("div", { className: "empty", children: "Start a conversation using this server's personality." }), messages.map((message, index) => (_jsxs("div", { className: `message-row ${message.speaker}`, children: [message.speaker === 'assistant' && (_jsx("div", { className: "message-avatar", children: _jsx("img", { src: "/GiadaPfp.png", alt: "Giada" }) })), _jsxs("div", { className: "bubble", children: [_jsx("div", { className: "bubble-speaker-label", children: message.speaker === 'user' ? 'You' : 'Giada' }), _jsx("div", { className: "bubble-text", children: message.text })] })] }, index)))] }), _jsxs("div", { className: "composer", children: [_jsx("button", { className: recording ? 'recording' : '', disabled: !voiceEnabled, onPointerDown: () => void startMicrophone(socket).then(() => setRecording(true)), onPointerUp: () => { stopMicrophone(socket); setRecording(false); }, children: _jsx(Mic, { size: 17 }) }), _jsx("input", { value: text, placeholder: "Message Giada\u2026", onChange: (e) => setText(e.target.value), onKeyDown: (e) => { if (e.key === 'Enter')
                            send(); } }), _jsx("button", { onClick: send, children: _jsx(Send, { size: 17 }) })] })] }));
}
